    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="/ubahpengelola/{{ $datapengelola->id }}"method="POST" enctype="multipart/form-data">
                ...
                <input type="text" name="name" value="{{ $datapengelola->name }}" class="form form-control"> <br>
                </div>
                <div class="form from-grup">
                <span>Email</span>
                <input type="text" name="email"value="{{ $datapengelola->email }}" class="form form-control"> <br>
                </div>
                <div class="form from-grup">
